...
?>
<div>
  <a href="Castell.php" class="boto" ><?php echo _("Torna als Castells"); ?></a>
</div>
<div>
<br>
</div>
 ...
 ?>
  ...
  <label for="sel1"><?php echo _("Esdeveniment"); ?>:</label>
...
<h3>Copiar des de:</h3>
  ...
  <br>
  <label for="sel1"><?php echo _("Plantilla"); ?>:</label>
  <select class="form_edit" name="plantillaid">
	<option value="-1" selected><?php echo _("Selecciona plantilla"); ?></option>
<?php
...
<br><br>
  ...
  <select class="form_edit" name="castellid">
	<option value="-1" selected><?php echo _("Selecciona castell"); ?></option>
<?php
...
<br><br>
  <button type="Submit" class="boto"><?php echo _("GAAAASS"); ?></button>
</div>
</form>
   </body>
</html>
