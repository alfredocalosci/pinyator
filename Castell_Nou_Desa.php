...
{
	echo _("Has seleccionat una plantilla i un casetell d'un esdeveniment per copiar, i com es normal el sistema no sap quin es el bo, encara no sap llegir la ment :P")."<br />";
}
...
mysqli_close($conn);
?>
<a href='Castell.php'><?php echo _("Torna als Castells"); ?></a>
</body>
</html>
