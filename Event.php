...
if (mysqli_num_rows($result) > 0)
{
    ...
    while($row = mysqli_fetch_assoc($result))
	{
		...
		{
			$linkCastells = "<a href='Castell_Nou.php?id=".$row["EVENT_ID"]."' class='boto' >"._('Nou castell')."</a>";
		}
		...
		if(EsEventLv2())
		{
			if ($row["CASTELLS_QTA"] > 0)
				...
				echo "<td class='llistes'><button class='boto boto_remove' name='Event_Esborra.php?id=".$row["EVENT_ID"]."' onClick='ShowPopup(this)' >"._('Esborra')."</button></td>";
		}
		echo "</tr>";
    }
}
