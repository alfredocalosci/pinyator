...
<head>
  ...
  <meta charset="utf-8">
<?php $menu=4; include "$_SERVER[DOCUMENT_ROOT]/pinyator/utils/Head.php";?>
...
<table class='butons'>
	<tr class='butons'>
<?php
	echo "<th class='butons'><a href='Castell_Nou.php".$eventLink."' class='boto' >"._('Nou')."</a></th>";
?>
		<th></th>
		<th class='butons'>
			<a href="Castell.php?e=1" class="boto" ><?php echo _("Actius"); ?></a>
			<a href="Castell.php?e=-1" class="boto" ><?php echo _("Inactius"); ?></a>
		</th>
	</tr>
</table>
 <br>
		...
		while($row = mysqli_fetch_assoc($result))
		{
			...
			if (($event != $anterior) || ($anterior == ""))
			{
				...
				<table class='llistes fixed' id=".$row["EVENT_ID"].">
					<col width='74px' />
					<tr class='llistes'>
						<th class='llistes'>"._('Ordre')."</th>
						<th class='llistes'>"._('Castell')."</th>
						<th class='llistes'>"._('Hora')."</th>
						<th class='llistes'>"._('Públic')."</th>
						<th class='llistes'>"._('Creat')."</th>
						<th class='llistes'>"._('Esborra')."</th>
					</tr>";
				echo "<tr class='llistes'>
					<td class='llistes'><button class='boto' onClick='Ordena(".$row["EVENT_ID"].")'>"._('Ordena')."</button></td>
					<td class='llistes'><a href='Castell_Fitxa.php?id=".$row["CASTELL_ID"]."&a=1'>"._('Troncs i nuclis')."</a></td>
					<td class='llistes'><a href='Castell_Fitxa.php?id=".$row["CASTELL_ID"]."&a=1&t=1'>"._('Troncs')."</a></td>
					<td class='llistes'></td>
					<td class='llistes'></td>
					<td class='llistes'></td>
				</tr>";
