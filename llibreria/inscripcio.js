...
function Save(eventid, castellerid)
{
	...
	if(event_id > 0)
	{
		...
		var domElement = document.getElementById(elementNom);
		...
		xmlhttp.onreadystatechange = function()
		{
			...
			if (this.readyState == 4 && this.status == 200)
			{
				if (estat == 0)
				{
					domElement.style.backgroundColor = "#ff1a1a";
					domElement.innerHTML = domElement.dataset.novincLabel;
					operador=-1;
				}
				else
				{
					domElement.style.backgroundColor = "#33cc33";
					domElement.innerHTML = domElement.dataset.vincLabel;
					operador=1;
				}
