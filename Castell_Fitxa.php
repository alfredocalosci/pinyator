...
?>
	<div  class="sidenav" id="navlateral">
		...
		<button class="boto" onclick="download()"><?php echo _("Imatge"); ?></button>
		<button class="boto boto_remove" id="Neteja" onClick="Neteja()" <?php echo $autogenerat?"hidden":""; ?>><?php echo _("Neteja"); ?></button>
		<br><br>
		<button class="boto boto_remove" id="EsborraPaleta" onClick="EsborraMenu()"><?php echo _("Esborra"); ?></button>
		<button class="boto" id="EditaPaleta" onClick="EditaMenu()"><?php echo _("Edita"); ?></button>
		<br><br>
		<!--Popup
		...
		<?php echo _("Troncs"); ?>
		<br>
		<input type="text" id="myInput" class="form_edit" onkeyup="Buscar()" placeholder="<?php echo _('Cerca casteller...'); ?>" title="Type in a name">
	...
	<?php
		...
		if (mysqli_num_rows($result) > 0)
		{
			...
			while($row = mysqli_fetch_assoc($result))
			{
				...
				if($row["LESIONAT"]==1)
				{
					$lesionat="<img id='lesionat".$row["CASTELLER_ID"]."' src='images/lesionat.png'>";
				}

				$portarpeu = "";
				if($row["PORTAR_PEU"]==0)
				{
					$portarpeu="<img id='peu".$row["CASTELLER_ID"]."' src='images/peu_vermell.png'>";
				}

				$camisa = "";
				if($row["CAMISA"]==1)
				{
					$camisa="<img src='images/camisa.png'>";
				}
				...
				$info = "<a href='Casteller_Fitxa.php?id=".$row["CASTELLER_ID"]."' target='_blank'><img src='images/info.png'></a>";
		...
		$nom="";
		$canvasH=1200;
		$canvasW=$troncs?$resoluciopantalla:1400;
		$ps1="";
		$ps2="";
		$ps3="";
		$ps4="";
