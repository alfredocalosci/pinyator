<html>
<head>
	<title>Pinyator - <?php echo _("Posicions"); ?></title>
...
<?php $menu=7; include "$_SERVER[DOCUMENT_ROOT]/pinyator/Menu.php";?>
	<table class="butons">
	<tr>
		<th><a href="Posicio_Fitxa.php" class="boto" ><?php echo _("Nova posició"); ?></a></th>
	</tr>
	</table>
	<br>
	<table class="llistes" style="width:100%">
		<tr class="llistes">
			<th class="llistes"><?php echo _("Nom"); ?></th>
			<th class="llistes"><?php echo _("Es Nucli"); ?></th>
			<th class="llistes"><?php echo _("Es Pinya"); ?></th>
			<th class="llistes"><?php echo _("Es Tronc"); ?></th>
			<th class="llistes"><?php echo _("Es Folre"); ?></th>
			<th class="llistes"><?php echo _("Es Canalla"); ?></th>
		</tr>
<?php
